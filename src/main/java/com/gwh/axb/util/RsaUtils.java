...
import com.gwh.axb.exception.CodecException;
...
public final class RsaUtils {
    ...
    public static Map<String, Object> initKey() {
        try {
            ...
            throw new CodecException(String.format("生成密钥失败:%s", e.getMessage()));
        }
    }
    ...
    public static String encryptByPublicKey(String srcText, String pubKey) {
        try {
            ...
            throw new CodecException(String.format("公钥加密失败:%s", e.getMessage()));
        }
    }
    ...
    public static String decryptByPublicKey(String srcText, String pubKey) {
        try {
            ...
            throw new CodecException(String.format("公钥解密失败:%s", e.getMessage()));
        }
    }
    ...
    public static String encryptByPrivateKey(String srcText, String priKey) {
        ...
        try {
            ...
            throw new CodecException(String.format("私钥加密失败:%s", e.getMessage()));
        }
    }
    ...
    public static String decryptByPrivateKey(String srcText, String priKey) {
        try {
            ...
            throw new CodecException(String.format("私钥解密失败:%s", e.getMessage()));
        }
    }
